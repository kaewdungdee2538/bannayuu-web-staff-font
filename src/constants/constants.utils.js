...
export const HTTP_SLOT_SELECT_COMPANY_SUCCESS = 'HTTP_SLOT_SELECT_COMPANY_SUCCESS'
export const HTTP_SLOT_SELECT_COMPANY_CLEAR = 'HTTP_SLOT_SELECT_COMPANY_CLEAR'
